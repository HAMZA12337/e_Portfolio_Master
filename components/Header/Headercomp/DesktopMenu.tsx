  ...
  return (
    <div className="font-mono text-xs md:flex hidden flex-row items-center space-x-8 ">
      ...
      >
         ...
         <ReactScrollLink to="Awards" spy={true} smooth={true} offset={-100} duration={200}>
         &gt; 04. <span className="text-white  hover:cursor-pointer hover:text-AAsecondary duration-300">Awards</span>
        </ReactScrollLink>
      </motion.span>
      <motion.span
        initial={{
      ...
      >
       {/* // begin */}
       <ReactScrollLink to="Reflections" spy={true} smooth={true} offset={-100} duration={200}>
         &gt; 05. <span className="text-white  hover:cursor-pointer hover:text-AAsecondary duration-300">Reflections</span>
        </ReactScrollLink>
      </motion.span>
      <motion.span
        initial={{
      ...
      >
       ...
       {/* end */}
         {/* // begin */}
         <ReactScrollLink to="Cover_Letter" spy={true} smooth={true} offset={-100} duration={200}>
         &gt; 06. <span className="text-white  hover:cursor-pointer hover:text-AAsecondary duration-300">Cover_Letter</span>
        </ReactScrollLink>
      </motion.span>
      <motion.span
        initial={{
      ...
      >
       ...
       {/* end */}
         ...
         &gt; 07. <span className="text-white  hover:cursor-pointer hover:text-AAsecondary duration-300">Contact</span>
        </ReactScrollLink>
      </motion.span>
